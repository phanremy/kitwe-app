...
import { byGender, relToNode, withRelType } from 'family-tree/relatives/utils/methods';
...
const getSpouse = (store, spouses) => {
    ...
    const married = spouses.find(withRelType("married"));
    if (married)
...
//# sourceMappingURL=getSpouseNodesFunc.js.map
