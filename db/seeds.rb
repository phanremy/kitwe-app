...
admin = User.find_or_create_by(email: 'user1@example.com') { |user| user.password = 'yhnujm' }
visitor = User.find_or_create_by(email: 'user3@example.com') { |user| user.password = 'yhnujm' }
